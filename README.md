...
Самый простой способ настроить сервер — использовать готовый Bash-скрипт. Он задаст вам несколько вопросов (ваш домен, порт SSH, ключи) и сделает всё за вас автоматически.
...
sudo ./setup_node.sh
```
*(Не забудьте заменить ссылку на актуальный URL вашего репозитория, если клонируете свой форк)*
